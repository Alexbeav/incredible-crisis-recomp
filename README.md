...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/incredible-crisis-recomp/total)](https://github.com/Alexbeav/incredible-crisis-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/incredible-crisis-recomp/latest/total)](https://github.com/Alexbeav/incredible-crisis-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/incredible-crisis-recomp)](https://github.com/Alexbeav/incredible-crisis-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Incredible Crisis** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLUS-01225 disc image
...
|---|---|
| Region | USA |
| Disc serial | SLUS-01225 |
| Discs | 1 |
| Supported dump | Redump `Incredible Crisis (USA).cue` as CUE/BIN or CHD |
| BIOS | SCPH-1001 (USA), 524288 bytes, SHA-256 `71af94d1e47a68c11e8fdb9f8368040601514a42a5a399cda48c7d3bff1e99d3` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/incredible-crisis-recomp/releases)
   and extract it into a writable folder.
2. Start `Incredible_Crisis` (`.exe` on Windows).
...
named `diagnostic-mode.txt` next to `Incredible_Crisis.exe` and start the game as
usual, or run `Incredible_Crisis.exe --diagnostic`. Reproduce the problem, quit, then
run `Incredible_Crisis.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
