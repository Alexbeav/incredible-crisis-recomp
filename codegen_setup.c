...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Incredible Crisis",
    .project_root_env = "INCREDIBLE_CRISIS_PROJECT_ROOT",
    .build_dir_env = "INCREDIBLE_CRISIS_BUILD_DIR",
    .force_setup_env = "INCREDIBLE_CRISIS_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_012.25_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Incredible_Crisis",
    .prepare_note =
